--TEST--
MongoDB\Driver\Manager::removeSubscriber() unregisters a subscriber
--SKIPIF--
...
MySubscriber(s2) commandStarted: ping
MySubscriber(s1) commandSucceeded: ping
MySubscriber(s2) commandSucceeded: ping
ping: 1
MySubscriber(s1) commandStarted: ping
MySubscriber(s1) commandSucceeded: ping
ping: 1
