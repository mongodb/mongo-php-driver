...
$bson = hex2bin('18000000136400000000A1EDCCCE1BC2D300000000FE5F00');
...
$json = '{"d" : {"$numberDecimal" : "1E+6135"}}';

// extJSON to Canonical extJSON
echo json_canonicalize(toJSON(fromJSON($json))), "\n";

$canonicalJson = '{"d" : {"$numberDecimal" : "1.000000000000000000000000E+6135"}}';
