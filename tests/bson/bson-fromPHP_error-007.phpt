...
echo throws(function() {
    MongoDB\BSON\fromPHP(new MySerializable(["\0" => 1]));
}, 'MongoDB\Driver\Exception\UnexpectedValueException'), "\n";

echo "\nTesting array with one trailing null byte in field name\n";
echo throws(function() {
    MongoDB\BSON\fromPHP(new MySerializable(["a\0" => 1]));
}, 'MongoDB\Driver\Exception\UnexpectedValueException'), "\n";

echo "\nTesting array with multiple null bytes in field name\n";
echo throws(function() {
    MongoDB\BSON\fromPHP(new MySerializable(["\0\0\0" => 1]));
}, 'MongoDB\Driver\Exception\UnexpectedValueException'), "\n";
...
echo throws(function() {
    MongoDB\BSON\fromPHP(new MySerializable((object) ["\0" => 1]));
}, 'MongoDB\Driver\Exception\UnexpectedValueException'), "\n";

echo "\nTesting object with one trailing null byte in field name\n";
echo throws(function() {
    MongoDB\BSON\fromPHP(new MySerializable((object) ["a\0" => 1]));
}, 'MongoDB\Driver\Exception\UnexpectedValueException'), "\n";

echo "\nTesting object with multiple null bytes in field name\n";
echo throws(function() {
    MongoDB\BSON\fromPHP(new MySerializable((object) ["\0\0\0" => 1]));
}, 'MongoDB\Driver\Exception\UnexpectedValueException'), "\n";
