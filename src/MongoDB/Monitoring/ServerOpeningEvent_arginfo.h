 ...
 * Stub hash: 6099b3429fb14cdb7ea618302fb1270e9c5011f0 */
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_MongoDB_Driver_Monitoring_ServerOpeningEvent___wakeup, 0, 0, IS_VOID, 0)
ZEND_END_ARG_INFO()
...
static ZEND_METHOD(MongoDB_Driver_Monitoring_ServerOpeningEvent, __wakeup);
...
static const zend_function_entry class_MongoDB_Driver_Monitoring_ServerOpeningEvent_methods[] = {
	...
	ZEND_ME(MongoDB_Driver_Monitoring_ServerOpeningEvent, __wakeup, arginfo_class_MongoDB_Driver_Monitoring_ServerOpeningEvent___wakeup, ZEND_ACC_PUBLIC|ZEND_ACC_FINAL)
	ZEND_FE_END
};
