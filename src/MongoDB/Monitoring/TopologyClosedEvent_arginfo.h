 ...
 * Stub hash: ce96aca6a81d1806e807d7a9f68dd6648872d80f */
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_MongoDB_Driver_Monitoring_TopologyClosedEvent___wakeup, 0, 0, IS_VOID, 0)
ZEND_END_ARG_INFO()
...
static ZEND_METHOD(MongoDB_Driver_Monitoring_TopologyClosedEvent, __wakeup);
...
static const zend_function_entry class_MongoDB_Driver_Monitoring_TopologyClosedEvent_methods[] = {
	...
	ZEND_ME(MongoDB_Driver_Monitoring_TopologyClosedEvent, __wakeup, arginfo_class_MongoDB_Driver_Monitoring_TopologyClosedEvent___wakeup, ZEND_ACC_PUBLIC|ZEND_ACC_FINAL)
	ZEND_FE_END
};
