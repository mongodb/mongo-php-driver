...
PHP_METHOD(InsertBatch, add)
{
	...
	intern = (php_phongo_insertbatch_t *)zend_object_store_get_object(getThis() TSRMLS_CC);
...
/* }}} */
/* {{{ proto int InsertBatch::count()
   Returns how many items have been added to this batch */
PHP_METHOD(InsertBatch, count)
{
	php_phongo_insertbatch_t *intern;
	zend_error_handling	error_handling;
 ...
 */
/* {{{ MongoDB\Write\InsertBatch */

ZEND_BEGIN_ARG_INFO_EX(ai_InsertBatch_add, 0, 0, 1)
	ZEND_ARG_INFO(0, document) 
ZEND_END_ARG_INFO();

ZEND_BEGIN_ARG_INFO_EX(ai_InsertBatch_count, 0, 0, 0)
ZEND_END_ARG_INFO();


static zend_function_entry php_phongo_insertbatch_me[] = {
	PHP_ME(InsertBatch, add, ai_InsertBatch_add, ZEND_ACC_PUBLIC)
	PHP_ME(InsertBatch, count, ai_InsertBatch_count, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
