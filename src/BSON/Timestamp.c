...
static HashTable* php_phongo_timestamp_get_properties_hash(zend_object* object)
{
...
static PHP_METHOD(MongoDB_BSON_Timestamp, __serialize)
{
	...
	PHONGO_RETURN_PROPERTIES_ARR(php_phongo_timestamp_get_properties_hash(Z_OBJ_P(getThis())));
}
...
{
	*is_temp = 0;
	return php_phongo_timestamp_get_properties_hash(object);
}
