...
/* {{{ proto MongoDB\GeneratedId GeneratedId::__construct(mixed $id, integer $index)
...
static zend_function_entry php_phongo_generatedid_me[] = {
	PHP_ME(GeneratedId, __construct, ai_GeneratedId___construct, ZEND_ACC_PUBLIC|ZEND_ACC_FINAL)
	PHP_ME(GeneratedId, getId, ai_GeneratedId_getId, ZEND_ACC_PUBLIC|ZEND_ACC_FINAL)
	PHP_ME(GeneratedId, getIndex, ai_GeneratedId_getIndex, ZEND_ACC_PUBLIC|ZEND_ACC_FINAL)
	PHP_FE_END
};
...
PHP_MINIT_FUNCTION(GeneratedId)
{
	...
	INIT_NS_CLASS_ENTRY(ce, "MongoDB", "GeneratedId", php_phongo_generatedid_me);
