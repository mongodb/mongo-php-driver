...
sudo apt-get download mongodb-enterprise-server=3.2.0~rc5
sudo apt-get download mongodb-enterprise-mongos=3.2.0~rc5
...
dpkg -x mongodb-enterprise-server_3.2.0~rc5_amd64.deb 3.2.0~rc5
dpkg -x mongodb-enterprise-mongos_3.2.0~rc5_amd64.deb 3.2.0~rc5
